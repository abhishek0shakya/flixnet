...
export function sidebar() {
    ...
    <div class="sidebar-footer">
        <p class="copyright">
            @Copyright 2023 <a href="https://github.com/Vrishti05/" target="_blank">Varsha 💜 Vrishti </a>
        </p>
    ...
    function genreLink() {
        for (const [genreId, genreName] of Object.entries(genreList)) {
            ...
            link.setAttribute("href", `./movie-list.html?with_genres=${genreId}`); // Adjusted href
            link.setAttribute("menu-close", "");
            link.setAttribute("onclick", `getMovieList("with_genres=${genreId}", "${genreName}")`);
            link.textContent = genreName;

            sidebarInner.querySelector(".sidebar-list").appendChild(link); // Adjusted the selector here
        }
